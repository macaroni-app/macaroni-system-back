...
export const UserSchema = z.object({
  ...
  refreshToken: z.array(z.string().min(1)).optional(),
...
export type ChangeIsActiveUserBodyType = z.infer<
  typeof ChangeIsActiveUserSchema
>["body"];
export type ChangeIsActiveUserParamsType = z.infer<
  typeof ChangeIsActiveUserSchema
>["params"];
