...
usersRouter.put('/change-password/:id', [verifyToken as RequestHandler, verifyRole(ProfileBase.users.editOwnInfo)], usersController.changePassword as RequestHandler)
