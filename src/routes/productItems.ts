...
productItemsRouter.get('/', [verifyToken as RequestHandler, verifyRole(RoleCodes.ADMIN, RoleCodes.SELLER), schemaValidator(GetProductItemsSchema)], productItemsController.getAll as RequestHandler)

// GET - http://localhost:3000/api/v1/productItems/:id
productItemsRouter.get('/:id', [verifyToken as RequestHandler, verifyRole(RoleCodes.ADMIN, RoleCodes.SELLER), schemaValidator(GetProductItemsSchema)], productItemsController.getOne as RequestHandler)

// POST - http://localhost:3000/api/v1/productItems
productItemsRouter.post('/', [verifyToken as RequestHandler, verifyRole(RoleCodes.ADMIN, RoleCodes.SELLER), schemaValidator(CreateProductItemsSchema)], productItemsController.store as RequestHandler)

// POST - http://localhost:3000/api/v1/productItems
productItemsRouter.post('/bulkCreate', [verifyToken as RequestHandler, verifyRole(RoleCodes.ADMIN, RoleCodes.SELLER), schemaValidator(CreateManyProductItemsSchema)], productItemsController.storeMany as RequestHandler)
...
productItemsRouter.put('/bulkUpdate', [verifyToken as RequestHandler, verifyRole(RoleCodes.ADMIN, RoleCodes.SELLER), schemaValidator(UpdateManyProductItemsSchema)], productItemsController.updateMany as RequestHandler<{}, {}, UpdateManyProductItemsBodyType, {}>)
...
productItemsRouter.put('/bulkDelete', [verifyToken as RequestHandler, verifyRole(RoleCodes.ADMIN), schemaValidator(DeleteManyProductItemsSchema)], productItemsController.deleteMany as RequestHandler<{}, {}, DeleteManyProductItemsBodyType, {}>)
